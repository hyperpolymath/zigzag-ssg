...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/zigzag-ssg/security/advisories/new)
...
For non-critical security concerns, you may open a private security issue via GitHub Security Advisories. For critical vulnerabilities, always use the Security Advisory feature above.
...
- This repository (`hyperpolymath/zigzag-ssg`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/zigzag-ssg/security/advisories)
...
When using zigzag-ssg, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/zigzag-ssg/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/zigzag-ssg/security/advisories/new) |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/zigzag-ssg/discussions) |
...
*Thank you for helping keep zigzag-ssg and its users safe.*
